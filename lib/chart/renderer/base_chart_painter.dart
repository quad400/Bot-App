...
import '../model/chart_style.dart' show ChartStyle;
import '../entity/k_line_entity.dart';
import '../model/k_chart_widget.dart';
...
abstract class BaseChartPainter extends CustomPainter {
  ...
  void getMainMaxMinValue(KLineEntity item, int i) {
    ...
    if (mainState == MainState.MA) {
      ...
      maxPrice = max(item.bollingerBandsUpper ?? 0, item.high);
      minPrice = min(item.bollingerBandsLower ?? 0, item.low);
    } else {
      maxPrice = item.high;
      minPrice = item.low;
    }
